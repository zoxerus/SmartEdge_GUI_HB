...
db_logger = logging.getLogger() # get_logger("coordinator", "Console", 10, "192.168.1.101")
db_logger_metric = logging.getLogger() #get_logger("Coordinator", "Metric", 10, "192.168.1.101")
